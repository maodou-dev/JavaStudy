...
//        String logoPath = "D:\\qrCode\\test.jpg";
        String destPath = "D:\\qrCode";
        String text2 = "https://openauth.alipay.com/oauth2/publicAppAuthorize.htm?app_id=APPID&scope=SCOPE&redirect_uri=https%3A%2F%2Fauth.example.com%2FauthCallBack";
//        System.out.println(QRCodeUtils.encode(text2, null, destPath, false));

        System.out.println(QRCodeUtils.encode(text2));
